    ...
    <div class="container">
      <div class="checkout-addr">
        ...
        <div class="addr-list-wrap">
          <div class="addr-list">
            <ul>
              <li v-for="(item,index) in filterAdd" v-bind:class="{'check':index==curIndex}" @click="curIndex = index">
                <dl>
                  <dt>{{item.userName}}</dt>
                ...
                <div class="addr-opration addr-del" >
                  <a href="javascript:;" class="addr-del-btn" @click="delFlag=true;pindex=index">
          ...
          <div class="shipping-addr-more">
            <a class="addr-more-btn up-down-btn" href="javascript:" @click="showMore(limitNum)">
              more
              <i class="i-up-down">
        ...
        <div class="vislay" v-if="delFlag || editFlag"></div>
              ...
              <div class="confirm-tips">
                <div class="md-form-item">
                  ...
                  <div class="md-form-item__content" style="margin-left: 80px;">
                    <div  class="el-input">
                      <input type="text" autocomplete="off" class="md-input__inner"  style="width: 22em;">
                    </div>
                  </div>
                </div>
                <div class="md-form-item">
...
export default {
    ...
    methods:{
        ...
        showMore:function(num){
          ...
          //return this.limitNum == 3 ? this.limitNum=this.addressList.length : 3;
        },
        setDefault:(id) =>{
          ...
          //     item.isDefault = true;
          //     this.addressList[curIndex].isDefault = false;
          // }
        },
        delProduct:()=>{
